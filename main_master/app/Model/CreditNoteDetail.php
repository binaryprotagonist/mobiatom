...
class CreditNoteDetail extends Model
{
    ...
    protected $fillable = [
        'uuid', 'credit_note_id', 'item_id', 'item_condition', 'item_uom_id', 'discount_id', 'is_free', 'is_item_poi', 'promotion_id', 'item_qty', 'item_price', 'item_gross', 'item_discount_amount', 'item_net', 'item_vat', 'item_excise', 'item_grand_total', 'batch_number', 'reason','item_expiry_date' ];
