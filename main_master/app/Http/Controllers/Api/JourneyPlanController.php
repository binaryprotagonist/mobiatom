...
class JourneyPlanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->route) {
            $name = $request->route;
            $journey_plans_query->whereHas('route', function ($q) use ($name) {
                $q->where('route_name', 'like', '%' . $name . '%');
            });
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($isActivate = checkWorkFlowRule('Journey Plan', 'create', $current_organisation_id)) {
                ...
                //$this->createWorkFlowObject($isActivate, 'Journey Plan);
            }
            ...
            if ($isActivate = checkWorkFlowRule('Journey Plan', 'create', $current_organisation_id)) {
                $this->createWorkFlowObject($isActivate, 'Journey Plan', $request, $journey_plans);
            }
                        ...
                        try {
                            ...
                            if ($planType == 2) {
                                ...
                                if (
                                    ...
                                    (isset($row[66]) and $row[66] != "") ||
                                    (isset($row[69]) and $row[69] != "") ||
                                ...
                                if (
                                    ...
                                    (isset($row[90]) and $row[90] != "") ||
                                    (isset($row[93]) and $row[93] != "")
                                ) {
                            ...
                            if ($planType == 1) {
                                ...
                                if (
                                    ...
                                    } else if ((isset($row[111]) and $row[111] != "")) {
                            ...
                            foreach ($journey_plan_weeks_ids as $key => $journeyPlanWeek) {
                                ...
                                if (isset($row[$startColumn + 3]) && $row[$startColumn + 3]) {
                                ...
                                if (isset($row[$startColumn + 6]) && $row[$startColumn + 6]) {
                                ...
                                if (isset($row[$startColumn + 9]) && $row[$startColumn + 9]) {
                                ...
                                if (isset($row[$startColumn + 15]) && $row[$startColumn + 15]) {
                                ...
                                if (isset($row[$startColumn + 18]) && $row[$startColumn + 18]) {
                            ...
                            try {
                                ...
                                foreach ($journey_plan_weeks_ids as $key => $journeyPlanWeek) {
                                    ...
                                    if (isset($row[$startColumn]) && $row[$startColumn]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 1, (is_object($customer)) ? $customer->id : null);

                                        $journey_plan_customer = $this->savePlanCustomer(
                                            $journeyPlanWeek['journey_id'],
                                            $journey_plan_days->id,
                                            (is_object($customer)) ? $customer->id : null,
                                            $row[$startColumn + 1],
                                            $row[$startColumn + 2],
                                            (is_object($merchandiser)) ? $merchandiser->user_id : 0
                                        );

                                        // $journey_plan_customer = $this->savePlanCustomer($journeyPlanWeek['journey_id'], $journey_plan_days->id, (is_object($customer)) ? $customer->id : Null, $key + 1, $row[$startColumn + 1], $row[$startColumn + 2]);
                                    ...
                                    if (isset($row[$startColumn + 3]) && $row[$startColumn + 3]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 2, (is_object($customer)) ? $customer->id : null);
                                    ...
                                    if (isset($row[$startColumn + 6]) && $row[$startColumn + 6]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 3, (is_object($customer)) ? $customer->id : null);
                                    ...
                                    if (isset($row[$startColumn + 9]) && $row[$startColumn + 9]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 4, (is_object($customer)) ? $customer->id : null);
                                    ...
                                    if (isset($row[$startColumn + 12]) && $row[$startColumn + 12]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 5, (is_object($customer)) ? $customer->id : null);
                                    ...
                                    if (isset($row[$startColumn + 15]) && $row[$startColumn + 15]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 6, (is_object($customer)) ? $customer->id : null);
                                    ...
                                    if (isset($row[$startColumn + 18]) && $row[$startColumn + 18]) {
                                        ...
                                        $this->deletePlanCustomer($journeyPlanWeek['journey_id'], $journeyPlanWeek['week_id'], 7, (is_object($customer)) ? $customer->id : null);
    ...
    private function savePlanCustomer($journey_id, $journey_plan_days_id, $customer_id, $start_time, $end_time, $merchandiser_id)
    {
        if (isset($journey_id) && $journey_id) {
        ...
        $customer_merchandiser = CustomerMerchandizer::where('user_id', $customer_id)
            ->where('merchandiser_id', $merchandiser_id)
            ->first();
        ...
        if (!is_object($customer_merchandiser)) {
            ...
            if (is_object($customer) && is_object($merchandiser)) {
                $customer_merchandiser                  = new CustomerMerchandizer;
                $customer_merchandiser->user_id         = $customer_id;
                $customer_merchandiser->merchandizer_id = $merchandiser_id;
    ...
    private function saveCustomerMerchandiser($merchandiser_id, $customer_id)
    {
        ...
        if (is_object($customer)) {
            $customer_merchandiser = CustomerMerchandizer::where('user_id', $customer->user_id)
                ->where('merchandizer_id', $merchandiser_id)
                ->first();
            ...
            if (empty($customer_merchandiser)) {
                ...
                if (is_object($customer) && is_object($merchandiser)) {
                    $customer_merchandiser                  = new CustomerMerchandizer;
                    $customer_merchandiser->user_id         = $customer->user_id;
                    $customer_merchandiser->merchandizer_id = $merchandiser_id;
                    $customer_merchandiser->save();
                }
            }
