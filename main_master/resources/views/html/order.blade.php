            ...
            <div class="pcs-template-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="vertical-align: top; text-align:right;width:50%;">
                                <span class="pcs-entity-title">ORDER </span><br>
                                <span id="tmp_entity_number" style="font-size: 10pt;" class="pcs-label"><b>Order#
                                        {{$order->order_number}}</b></span><br>
                                <span class="mabaldue">ORDER TYPE </span>
                                <span id="tmp_entity_number" style="font-size: 10pt;"
                                class="pcs-label"><b>{{ model($order->orderType, 'name') }}</b></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                        ...
                                        <strong>
                                            <span class="pcs-customer-name" id="zb-pdf-customer-detail">
                                                @if (is_object($order->user))
                                                    <a href="#">{{ $order->user->getName() }}</a>
                                                @elseif (is_object($order->depot))
                                                    <a href="#">{{ $order->depot->depot_name }}</a>
                                                @endif
                                            </span>
                                        </strong>
                                        <span style="white-space: pre-wrap;word-wrap: break-word;"
                                            id="tmp_org_address"><br> <b>{{  $order->organisation->org_street1 }}</b>
                                            <br>{{  $order->organisation->org_street2 }}<br>{{ $order->organisation->org_city }}
                                            <br>{{ $order->organisation->org_postal }}
                                            {{ $order->organisation->org_state }}<br>{{ $order->organisation->country }}
                                        </span>
                                    </span>
                                </div>
                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:right;">
                                                <span
                                                    id="tmp_entity_date">{{ date('d-m-Y', strtotime($order->order_date)) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                            ...
                                            <td style="text-align:right;">
                                                <span
                                                    id="tmp_ref_number">{{ model($order->paymentTerm, 'name') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                            ...
                                            <td style="text-align:right;">
                                                <span>{{ \Carbon\Carbon::parse($order->due_date)->format('d M Y') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                            ...
                                            <td style="text-align:right;">
                                                <span>{{ model($order->organisation, 'org_postal') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                ...
                <table style="width:100%;margin-top:20px;table-layout:fixed;" class="pcs-itemtable" border="0"
                    ...
                    <tbody class="itemBody">
                        @include('html.itemDetail', ['item_details' => $order->orderDetails])
                    </tbody>
                </table>
                        ...
                        <table class="pcs-totals" cellspacing="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format($order->total_gross, 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Vat </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format($order->total_vat, 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Excise </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format($order->total_excise, 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Net Total </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format($order->total_net, 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Discount </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format($order->total_discount_amount, 2) }}</td>
                                </tr>
                                <tr style="height:40px;" class="pcs-balance">
                                    ...
                                    <td id="tmp_total" valign="middle" align="right"
                                        style="width:120px;;padding: 10px 10px 10px 5px;"><b>{{ number_format($order->grand_total, 2) }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div style="width: 100%;margin-top: 10px;">
                    <table cellspacing="0" border="0" width="100%">
                        <tbody>
                            ...
                            <td class="total-in-words-value text-align-right"><i><b>{{ convertToCurrency($order->grand_total) }}</b></i>
                                </td>
                            </tr>
                        </tbody>
                    </table>
