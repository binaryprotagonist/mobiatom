                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="vertical-align: top; text-align:right;width:50%;">
                                <span class="pcs-entity-title">EXPENSE </span><br>
                                <span id="tmp_entity_number" style="font-size: 10pt;" class="pcs-label"><b>Expense#
                                        {{$expense->estimate_code}}</b></span><br>
                                ...
                                <div style="clear:both;width:50%;margin-top: 20px;">
                                    ...
                                    <span style="white-space: pre-wrap;line-height: 15px;" id="tmp_billing_address">
                                        ...
                                        <span style="white-space: pre-wrap;word-wrap: break-word;"
                                            id="tmp_org_address"><br>
                                            <b>{{  $estimation->organisation->org_street1 }}</b>
                                ...
                                <table style="float:right;table-layout: fixed;word-wrap: break-word;width: 100%;"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right;">
                                                <span id="tmp_ref_number">{{ model($estimation, 'subject') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
