    ...
    <div id="ember549" class="ember-view">
        <div class="pcs-template">
            ...
            <div class="pcs-template-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="vertical-align: top; text-align:right;width:50%;">
                                ...
                                <span id="tmp_entity_number" style="font-size: 10pt;" class="pcs-label"><b>Invoice#
                                        {{$invoice->invoice_number}}</b></span><br>
                                <span class="mabaldue">Balance Due </span>
                                <span id="tmp_entity_number" style="font-size: 10pt;"
                                    class="pcs-label"><b>AED662.75</b></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                    ...
                                    <span style="white-space: pre-wrap;line-height: 15px;" id="tmp_billing_address">
                                        <strong>
                                            <span class="pcs-customer-name" id="zb-pdf-customer-detail">
                                                @if (is_object($invoice->user))
                                                    <a href="#">{{ $invoice->user->getName() }}</a>
                                                @elseif (is_object($invoice->depot))
                                                    <a href="#">{{ $invoice->depot->depot_name }}</a>
                                                @endif
                                            </span>
                                        </strong>
                                        <span style="white-space: pre-wrap;word-wrap: break-word;"
                                            id="tmp_org_address"><br> <b>{{  $invoice->organisation->org_street1 }}</b>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:right;">
                                                <span
                                                    id="tmp_entity_date">{{ date('d-m-Y', strtotime($invoice->invoice_date)) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                            ...
                                            <td style="text-align:right;">
                                                <span
                                                    id="tmp_ref_number">{{ model($invoice->paymentTerm, 'name') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right;">
                                                <span>{{ model($invoice->organisation, 'org_postal') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                ...
                <table style="width:100%;margin-top:20px;" class="pcs-itemtable" border="0">
                    <thead>
                        <tr style="height:17px;">
                            <td style="padding: 5px 5px 2px 5px;text-align: center;" valign="bottom"
                        ...
                        <table class="pcs-totals" cellspacing="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($invoice->invoices->pluck('item_gross')->toArray()), 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Vat </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($invoice->invoices->pluck('item_vat')->toArray()), 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Excise </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($invoice->invoices->pluck('item_net')->toArray()), 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Net Total </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($invoice->invoices->pluck('item_excise')->toArray()), 2) }}</td>
                                </tr>
                                <tr>
                                    <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Discount </td>
                                    <td id="tmp_subtotal" valign="middle" align="right"
                                        style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($invoice->invoices->pluck('item_discount_amount')->toArray()), 2) }}</td>
                                </tr>
                                <tr style="height:40px;" class="pcs-balance">
                                    ...
                                    <td id="tmp_total" valign="middle" align="right"
                                        style="width:120px;;padding: 10px 10px 10px 5px;"><b>{{ number_format(array_sum($invoice->invoices->pluck('item_grand_total')->toArray()), 2) }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div style="width: 100%;margin-top: 10px;">
                    <table cellspacing="0" border="0" width="100%">
                        <tbody>
                            ...
                            <td class="total-in-words-value text-align-right"><i><b>{{ convertToCurrency(array_sum($invoice->invoices->pluck('item_grand_total')->toArray())) }}</b></i>
                                </td>
                            </tr>
                        </tbody>
                    </table>
