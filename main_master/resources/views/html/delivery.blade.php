                  ...
                  <tbody>
                     <tr>
                        <td style="vertical-align: top; width:50%;">
                           ...
                           <span style="white-space: pre-wrap;word-wrap: break-word;" id="tmp_org_address">Company ID : 1000
                           S.G Highway
                           Ahmedabad Jharkhand 382350
                           India
                           GSTIN 204783838383123</span>
                           </span>
                        </td>
                        <td style="vertical-align: top; text-align:right;width:50%;">
                           <span class="pcs-entity-title">DELIVERY </span><br>
                        <span id="tmp_entity_number" style="font-size: 10pt;" class="pcs-label"><b>Delivery # {{ $delivery->delivery_number }}</b></span>
                        </td>
                     </tr>
                  </tbody>
               </table>
                     ...
                     <tr>
                        <td style="width:60%;vertical-align:bottom;word-wrap: break-word;">
                           <div style="clear:both;width:50%;margin-top: 20px;">
                              ...
                              <br>
                           <span style="white-space: pre-wrap;line-height: 15px;" id="tmp_billing_address"><strong><span class="pcs-customer-name" id="zb-pdf-customer-detail"><a href="#/contacts/297877000000007196">{{ model($delivery->customer, 'firstname') }} {{ model($delivery->customer, 'lastname') }}</a></span></strong><br>
                              <span>
                                 <b>{{  $delivery->organisation->org_street1 }}</b>
                                 <br>{{  $delivery->organisation->org_street2 }}<br>{{ $delivery->organisation->org_city }}
                                 <br>{{ $delivery->organisation->org_postal }}
                                 {{ $delivery->organisation->org_state }}<br>{{ $delivery->organisation->country }}
                              </span>
                              </span>
                           </div>
                        </td>
                           ...
                           <table style="float:right;table-layout: fixed;word-wrap: break-word;width: 100%;" border="0" cellspacing="0" cellpadding="0">
                              <tbody>
                                 <tr>
                                    ...
                                    <span id="tmp_entity_date">{{ date('d/m/Y', strtotime($delivery->delivery_date)) }}</span>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                 ...
                                 <tr>
                                    <td style="text-align:right;padding:5px 10px 5px 0px;font-size: 10pt;">
                                       <span class="pcs-label">DELIVERY Type :</span>
                                    </td>
                                    <td style="text-align:right;">
                                    <span>{{ model($delivery->orderType, 'name') }}</span>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
               ...
               <table style="width:100%;margin-top:20px;table-layout:fixed;" class="pcs-itemtable" border="0" cellspacing="0" cellpadding="0">
                  <thead>
                     <tr style="height:17px;">
                        ...
                        <td style="padding: 5px 7px 2px 7px;width: 12%;" valign="bottom" rowspan="2" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                           <b>ITEM NAME</b>
                        </td>
                        <td style="padding: 5px 7px 2px 7px;width: 12%;" valign="bottom" rowspan="2" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                           <b>UOM	</b>
                        ...
                        <td style="padding: 5px 7px 2px 7px;" valign="bottom" rowspan="2" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                           <b>Price</b>
                        </td>
                        <td style="padding: 5px 7px 2px 7px;" valign="bottom" rowspan="2" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                           <b>Discount</b>
                  ...
                  <tbody class="itemBody">
                     @include('html.itemDetail', ['item_details' => $delivery->deliveryDetails])
                  </tbody>
               </table>
                     ...
                     <table class="pcs-totals" cellspacing="0" border="0" width="100%">
                        <tbody>
                           <tr>
                              ...
                              <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($delivery->deliveryDetails->pluck('item_gross')->toArray()), 2) }}</td>
                           </tr>
                           <tr>
                              <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Vat	</td>
                              <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($delivery->deliveryDetails->pluck('item_vat')->toArray()), 2) }}</td>
                           </tr>
                           <tr>
                              <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Excise	</td>
                              <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($delivery->deliveryDetails->pluck('item_net')->toArray()), 2) }}</td>
                           </tr>
                           <tr>
                              <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Net Total		</td>
                              <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($delivery->deliveryDetails->pluck('item_excise')->toArray()), 2) }}</td>
                           </tr>
                           <tr>
                              <td valign="middle" align="right" style="padding: 2px 10px 2px 0;">Discount		</td>
                              <td id="tmp_subtotal" valign="middle" align="right" style="width:120px;padding: 4px 10px 4px 5px;">{{ number_format(array_sum($delivery->deliveryDetails->pluck('item_discount_amount')->toArray()), 2) }}</td>
                           </tr>
                           <tr style="height:40px;" class="pcs-balance">
                              <td valign="middle" align="right" style="padding: 5px 10px 5px 0;"><b>Total</b></td>
                              <td id="tmp_total" valign="middle" align="right" style="width:120px;;padding: 10px 10px 10px 5px;"><b>{{ number_format(array_sum($delivery->deliveryDetails->pluck('item_grand_total')->toArray()), 2) }}</b></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
                  ...
                  <table cellspacing="0" border="0" width="100%">
                     <tbody>
                        <tr>
                           ...
                           <td class="total-in-words-value text-align-right"><i><b>{{ convertToCurrency(array_sum($delivery->deliveryDetails->pluck('item_grand_total')->toArray())) }}</b></i></td>
                        </tr>
                     </tbody>
                  </table>
                  <div style="clear: both;"></div>
