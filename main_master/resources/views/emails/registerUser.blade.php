                                                    ...
                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                      <table class="wrapper" role="module" data-type="image" border="0"
                                                        ...
                                                        <tbody>
                                                          ...
                                                          src="http://mobiato-msfa.com/application-backend/public/engear/Mobiato Invoice Logo-1024.png">
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  ...
                                                                  {{ $data->getDisplayNameAttribute() }}!&nbsp;</span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                ...
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #69D9FD; font-size: 18px"><strong>Thank
                                                                      you!&nbsp;</strong></span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                          ...
                                                          <tr>
                                                            <td align="center" bgcolor="#ffffff" class="outer-td"
                                                              ...
                                                              <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#69D9FD"
                                                                      class="inner-td"
                                                                      style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                      <a href="{{ $data->url }}"
                                                                        style="background-color:#69D9FD; border:1px solid #69D9FD; border-color:#69D9FD; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                ...
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #69D9FD; font-size: 18px"><strong>+
                                                  ...
                                                  <tr>
                                                    <td align="center" bgcolor="#f5f8fd" class="inner-td"
                                                      ...
                                                      <a href="#"
                                                        ...
                                                        target="_blank">♥ POWERED BY ENGEAR</a></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </td>
