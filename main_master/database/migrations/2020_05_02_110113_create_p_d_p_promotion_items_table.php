...
class CreatePDPPromotionItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('p_d_p_promotion_items');
    }
}
